 ...
 * @param [B] This should be Builder[ImplementingClass] to allow the builder to return the correct type on clone and update.
 */
abstract class Builder[B](parameters: Map[String, Any]) {
  ...
  protected def update(o: Any): B = {
    ...
    require(parameters contains nameOfInvokingMethod,
