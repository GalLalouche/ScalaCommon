...
object RichVector {
  ...
  implicit class richVector(private val $ : Vektor) extends AnyVal {
    ...
    /**
     * Calculates the vector that is the difference between this vector and its projection on
     * another vector. The resulting vector is orthogonal to the other vector.
     */
    ...
    /**
     * Calculates the projection of this vector on another vector. The resulting vector is parallel
     * to the other vector.
     */
