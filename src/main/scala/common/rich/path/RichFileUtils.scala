...
object RichFileUtils {
   ...
   * @throws FileAlreadyExistsException if a file (directory or actual) in the destination dir
   *     already exists with the same name as the src file.
   */
   ...
   * @throws FileAlreadyExistsException if a file (directory or actual) in the parent dir already
   *     exists with the same name as the requested new name for the file.
   */
   ...
   * @throws FileAlreadyExistsException if a file (directory or actual) in the destination dir
   *     already exists with the same name as the src directory.
   */
   ...
   * new directory. This method does not perform merging of any sort.
   * @throws FileAlreadyExistsException if a file (directory or actual) in the destination dir
   *     already exists with the same name as requested new name for the directory.
   */
   ...
   * @throws FileAlreadyExistsException if a file (directory or actual) in the parent directory
   *     already exists with the same name as requested new name for the directory.
   */
   ...
   * @throws FileAlreadyExistsException if a file (directory or actual) in the destination dir
   *     already exists with the same name as *any* file (directory or actual) in the source dir.
   */
    ...
    for (srcPath <- src.listFiles)
      for (dstPathWithSameName <- dstFileNamesToFullPaths.get(srcPath.name))
        throw new FileAlreadyExistsException(
          srcPath.path, dstPathWithSameName, "File with same name already exists")
